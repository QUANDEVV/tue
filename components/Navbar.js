...
/>
            ...
            <p className=" dark:text-white text-nft-black-1 font-semibold text-lg ml-1">Silverbells</p>
          </div>
        </Link>
        <Link href="/">
          <div
...
/>
            ...
            <p className=" dark:text-white text-nft-black-1 font-semibold text-lg ml-1">Silverbell </p>
          </div>
        </Link>
      </div>
